//! 密钥管理
//!
//! 在单进程中管理密钥生命周期：生成、持久化、轮换。
//! 与 iris-wasm-gateway 的 KeyManager 不同，此处密钥轮换
//! 直接更新内存中的 FileEncryptor，无需跨进程通知。
...
impl KeyPair {
    ...
    /// 用此密钥加密（随机 nonce），输出: [12字节 nonce][密文]
